  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form>
        ...
        <div>
          <p className="text-lg font-semibold ">Regural Price</p>
          <div className="flex w-full justify-center items-center space-x-6">
            <input
              ...
              min="50"
              required
              className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition dauration-200 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center "
            />
            {type === "rent" && (
              <div>
        ...
        <button
          type="submit"
          className="mb-6 w-full px-7 py-3 bg-blue-600 font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out"
        >
          Create Listing
        </button>
      </form>
